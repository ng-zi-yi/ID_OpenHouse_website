...
$(document).ready(function () {
    ...
    const APIKEY = "61e79d0aa0f7d226f9b75f8b";
    getContacts();
    ...
    $("#contact-submit").on("click", function (e) {
      ...
      let settings = {
        "async": true,
        "crossDomain": true,
        "url": "https://interactivedev-a4e7.restdb.io/rest/contact",
    ...
    function updateForm(id, contactName, contactEmail, contactMsg) {
      ...
      var settings = {
        "async": true,
        "crossDomain": true,
        "url": `https://interactivedev-a4e7.restdb.io/rest/contact/${id}`,//update based on the ID
        "method": "PUT",
        "headers": {
          "content-type": "application/json",
          "x-apikey": APIKEY,
